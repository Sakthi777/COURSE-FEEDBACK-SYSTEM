...
<head>
<meta charset="utf-8">
<title>Student & course Feedback System</title>
...
<form method="post" action="event_feedback_step_4.php" >
<div id="table"> 
    <div class="tr">
		<div class="td">
        	<label>Roll No : </label>
     ...
     <div class="td">
            ...
            <option value="NA" disabled selected> - - Select Topic - -</option>
            <?php
        ...
        <div class="tdd">
        	<input type="button" onClick="window.location='event_feedback_step_2.php'" value="BACK">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="NEXT" />
        </div>
