...
$sql=mysqli_query($al,"select * from event_feeds where roll='".mysqli_real_escape_string($al,$_POST['roll'])."' AND name='".mysqli_real_escape_string($al,$_POST['faculty'])."' AND subject='".mysqli_real_escape_string($al,$_POST['subject'])."'");
...
//Fetch Questions
$q = mysqli_fetch_array(mysqli_query($al, "SELECT * FROM event_questions WHERE id = '1'"));
...
<br>
<br>
<span class="SubHead">Feedback Step III</span>
<form method="post" action="event_feedback_step_5.php" >
<div id="table"> 
    <div class="tr">
		<div class="td">
        	<label>Roll No : </label>
...
<hr style="width:100%;">
	...
	<?php
		for($i=1;$i<=10;$i++)
		{
        	...
        	<input type="button" onClick="window.location='event_feedback_step_3.php'" value="BACK">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="SUBMIT" onClick="return confirm('Are you sure?')" />
            <br>
<br>
