...
<br>
<br>
<span class="SubHead">Course Feedback Step II</span>
...
<div id="table"> 
    <div class="tr">
     ...
     <div class="custom-select td">
			<select name="faculty_id" required>
            <option  value="NA" disabled selected> - - Select Department - -</option>
            <?php
			$x=mysqli_query($al,"select * from course");
			while($y=mysqli_fetch_array($x))
			{
			 ?>
             <option value="<?php echo $y['course_id'];?>"><?php echo $y['department'];?></option>
             <?php } ?>
                </select>
        </div>
      </div>
